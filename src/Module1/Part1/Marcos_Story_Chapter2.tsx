...
const Marcos_Story_Chapter2 = () => {
  return (
    <div className='w-full flex flex-col items-start'>
        ...
        <span className="font-bold font-bree mb-3 text-lg sm:text-xl">James' Story Chapter 2</span>
        <span className="mb-3 font-bold text-xl sm:text-3xl">
        The Message
        </span>
        </div>
        <div className="relative w-full pt-[56.25%] bg-white">
        <iframe src="https://player.vimeo.com/video/1114355562?h=b9eef0c2ce&amp;title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479"  allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"  referrerPolicy="strict-origin-when-cross-origin" style={{position:'absolute',top:'0',left:'0',width:'100%',height:'100%'}} title="06_James&#039; Story - Chapter 2 - The Message"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script>
