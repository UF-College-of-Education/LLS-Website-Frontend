...
const PracticingSkills = () => {
  ...
  return (
    <div className="w-full flex flex-col items-start px-1 sm:px-1 lg:px-8">
      ...
      <span className="font-bold font-bree mb-3 text-lg sm:text-xl">Practicing Skills</span>
        <span className="mb-3 font-bold text-xl sm:text-3xl">
      Practicing Open and Supportive Communication Skills: Remembering "TIES" That Bind
        </span>
      ...
      Next, watch at least one of the three videos to observe how to enact open and supportive communication skills to navigate one of the challenging topics.
</span> 
      </div>
    </div>
