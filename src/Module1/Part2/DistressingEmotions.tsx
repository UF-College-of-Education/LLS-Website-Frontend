...
const DistressingEmotions = () => {
  ...
  return (
    <div className="w-full flex flex-col items-start px-1 sm:px-1 lg:px-8">
      ...
      Practicing "TIES" : Talking to Spouse about Distressing Emotions and Concerns
        </span>
        
        <div className="relative w-full pt-[56.25%] bg-white">
        <iframe src="https://player.vimeo.com/video/1115289074?h=fc8c9d8cde&amp;title=0&amp;byline=0&amp;portrait=0&amp;badge=0&amp;autopause=0&amp;player_id=0&amp;app_id=58479" allow="autoplay; fullscreen; picture-in-picture; clipboard-write; encrypted-media; web-share"  referrerPolicy="strict-origin-when-cross-origin" style={{position:'absolute',top:'0',left:'0',width:'100%',height:'100%'}} title="29_Practicing TIES - Talking to a Child about Distressing Emotion"></iframe></div><script src="https://player.vimeo.com/api/player.js"></script></div>

      <div className="w-full flex flex-col items-start">
      <span className="my-6 w-full text-sm sm:text-base rounded-xl shadow-2xl p-4 bg-white border border-gray-300">
      Select one of the other "Practicing TIES" videos or select the next page button to conclude Part II and complete the Healthy Communication Practice™ Program.
</span> 
      </div>
    </div>
